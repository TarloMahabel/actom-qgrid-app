...
--
--  Built from: 001-init-inspections.sql, 002-app-wiring.sql, 003-publish-roles.sql, 004-publish-approval-optional.sql, 005-lock-ref-sequences.sql, 006-fix-silent-publish.sql, 007-no-empty-templates.sql, 008-fault-list.sql, 009-photo-storage.sql, 010-handover.sql, 011-fault-clearing.sql, 012-dashboard.sql, 013-planned-dates.sql
--
...
-- ============================================================
--  SECTION 14 — Group reference data
-- ============================================================
...
-- ============================================================
--  SECTION 15 — Division seed — EDIT BEFORE RUNNING
-- ============================================================
...
-- ============================================================
--  SECTION 16 — Migration ledger stamp
--
