-- =====================================================================
-- Create a draft intake, with its form configuration backfilled.
--
-- Run in the Supabase SQL editor. Safe to re-run: it will not duplicate
-- an intake with the same name.
--
-- Creates the intake as DRAFT. Configure it in the console under
-- Form setup, then publish there. Do not publish from SQL — the publish
-- gate checks things this script does not.
-- =====================================================================
