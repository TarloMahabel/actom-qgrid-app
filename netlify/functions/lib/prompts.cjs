...
const CHAT = d => [
  ...
  "Do not propose a corrective action of your own. You may report actions ALREADY RECORDED under a root",
  "cause, using the actions_for_cause lookup, and you should — knowing what was tried before is the point.",
  "But an invented action fills the field without anyone investigating, which is how a register reaches",
  "19% corrective action and stops recurrence nowhere. Report history; leave the proposing to the engineer.",
