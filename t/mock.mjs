...
export const DIVISION = { code: "MVS", name: "ACTOM MV Switchgear" };
export const BUILD = { commit: "abc1234", deployedAt: "now", context: "test" };
...
function q(table) {
  const chain = {
    ...
    limit() { return chain; }, maybeSingle() { return Promise.resolve(result(table)); },
...
export async function currentProfile() { return DATA.profiles[0]; }
export function explain(e) { return e?.message || "error"; }
